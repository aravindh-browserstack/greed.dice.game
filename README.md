...
<bold> DiceSet: </bold> 
Represents a set of dice thrown by the player

<bold>PlayerClass: </bold> 
Represents a player; Has methods to play & to be hashable.

<bold>GameClass: </bold>
Represents an actual game; Takes number of players as parameter.
